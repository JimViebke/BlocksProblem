...
public:
	...
	{
		if (command.string1 == "move")
		{
			if (command.string2 == "onto")
			{
				move_onto(command.num1, command.num2);
			}
			else if (command.string2 == "over")
			{
				move_over(command.num1, command.num2);
			}
		}
		else if (command.string1 == "pile")
		{
			if (command.string2 == "onto")
			{
				pile_onto(command.num1, command.num2);
			}
			else if (command.string2 == "over")
			{
				pile_over(command.num1, command.num2);
			}
		}
	}
